...
const Selector = ({valueCurrency, handlerCurrency}: ISelectorProps) => {
  const [selected, setSelected] = useState(valueCurrency);

  useEffect(() => {
    setSelected(valueCurrency)
  },[valueCurrency])
  useEffect(() => {
    handlerCurrency(selected);
  },[selected])
